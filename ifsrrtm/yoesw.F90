...
!  RSUN2 :  REAL     SOLAR FRACTION IN SPECTRAL INTERVALS AT 2KM LEVEL
...
!*    NIELSEN (2013) WATER CLOUD OPTICAL PROPERTIES

! RKPNWCA :  REAL   : C1 IN MASS EXTINCTION FORMULA
! RKPNWCB :  REAL   : C2 IN MASS EXTINCTION FORMULA
! RKPNWCC :  REAL   : C1 IN SINGLE SCATTERING ALBEDO FORMULA
! RKPNWCD :  REAL   : C2 IN SINGLE SCATTERING ALBEDO FORMULA
! RKPNWCE :  REAL   : C1 IN ASYMMETRY FACTOR FORMULA
! RKPNWCF :  REAL   : C2 IN ASYMMETRY FACTOR FORMULA
! RKPNWCG :  REAL   : C3 IN ASYMMETRY FACTOR FORMULA
! RKPNWCH :  REAL   : C4 IN ASYMMETRY FACTOR FORMULA
...
!*   NIELSEN (2020) WATER CLOUD OPTICAL PROPERTIES (RRTM)

! RKPNLWCA : REAL  : SCALED MASS ABSORPTION POLYNOMIAL COEFFICIENTS
...
CONTAINS
  ...
  WRITE(KOUTNO,*) REPEAT(' ',KDEPTH) // 'model%yrml_phy_rad%yreswrt : '
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'APAD, BPAD, RRAY sums = ', SUM(SELF%APAD), SUM(SELF%BPAD), SUM(SELF%RRAY)
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSUN ALLOCATED OF SHAPE = ', SHAPE(SELF%RSUN), ' SUM ', SUM(SELF%RSUN)
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSUN2 ALLOCATED OF SHAPE = ', SHAPE(SELF%RSUN2), ' SUM ', SUM(SELF%RSUN2)
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSWCE, RSWCP sums = ', SUM(SELF%RSWCE), SUM(SELF%RSWCP)
